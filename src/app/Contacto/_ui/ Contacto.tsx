...
function Contacto() {
  ...
  return (
    <div className="text-gray-200 bg-gray-900 dark:bg-gray-800 mt-10 rounded-lg  shadow-lg w-full font-sans mx-auto max-w-xl space-y-2 ">
      <section className="bg-gray-900 dark:bg-gray-800 rounded-lg p-8">
        {/* <div className="flex justify-center mb-6">
          <Image src="/logo.png" alt="Logo da XGirl.pt" className="rounded-md" width={150} height={150} />
        </div> */}
        <h1 className="text-4xl font-extrabold text-center text-pink-800 mb-4">Contato</h1>
        <h2 className="text-sm font-light text-center text-gray-400 mb-8">
