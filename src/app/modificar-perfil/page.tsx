...
const ModificarPerfil = () => {
  ...
  const handleGuardar = async () => {
    ...
    console.log("userUID a ser usado:", userUIDd);

    try {
      await updateProfileData(dataToUpdate, userUIDd);
      console.log("Perfil atualizado com sucesso na base de dados!");
    } catch (error: any) {
      console.error(
        "Erro ao atualizar perfil na base de dados:",
        error.message
      );
    }
  };
        ...
        <div className="bg-gradient-to-b from-gray-900 to-gray-700 w-full h-full mb-10 mt-0 border border-zinc-600 rounded-xl p-10">
          ...
          <div className="flex justify-between w-full mb-2 mt-2 my-10 py-2 px-10">
            <div className="w-26 mb-2">
              <p className="text-md text-white bg-zinc-400 px-10 py-2 rounded-md cursor-pointer transition duration-300 ease-in-out transform hover:scale-105 hover:bg-gray-500">
                Voltar
              </p>
            </div>
